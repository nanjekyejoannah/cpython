...
class TestPy3KWarnings(unittest.TestCase):
    ...
    def test_func_closure(self):
        ...
        def f(): pass
        with check_py3k_warnings() as w:
            self.assertWarning(f.func_closure, w, expected)
    ...
    def test_func_defaults(self):
        ...
        def f(): pass
        with check_py3k_warnings() as w:
            self.assertWarning(f.func_defaults, w, expected)
    ...
    def test_func_dict(self):
        ...
        def f(): pass
        with check_py3k_warnings() as w:
            self.assertWarning(f.func_dict, w, expected)
    ...
    def test_func_doc(self):
        ...
        def f(): pass
        with check_py3k_warnings() as w:
            self.assertWarning(f.func_doc, w, expected)
    ...
    def test_func_globals(self):
        ...
        def f(): pass
        with check_py3k_warnings() as w:
            self.assertWarning(f.func_globals, w, expected)
